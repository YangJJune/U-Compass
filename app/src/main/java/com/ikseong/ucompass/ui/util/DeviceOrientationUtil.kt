...
object DeviceOrientationUtil {
                ...
                override fun onSensorChanged(event: SensorEvent) {
                    when (event.sensor.type) {
                        Sensor.TYPE_ACCELEROMETER -> {
                            ...
                            filteredAccReading[1] = ALPHA * event.values[1] + (1 - ALPHA) * filteredAccReading[1]
                            filteredAccReading[2] = ALPHA * event.values[2] + (1 - ALPHA) * filteredAccReading[2]
                        ...
                        Sensor.TYPE_MAGNETIC_FIELD -> {
                            ...
                            filteredMagReading[1] = ALPHA * event.values[1] + (1 - ALPHA) * filteredMagReading[1]
                            filteredMagReading[2] = ALPHA * event.values[2] + (1 - ALPHA) * filteredMagReading[2]
    ...
    private fun updateOrientation(
        ...
        azimuthState: androidx.compose.runtime.MutableState<Float>
    ) {
        // 회전 행렬 계산
